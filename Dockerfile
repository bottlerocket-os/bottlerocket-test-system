...
# Copy binary
COPY --from=build-src /src/bottlerocket/bin/ec2-resource-agent ./
# Copy licenses
...
COPY --from=build-src /src/bottlerocket/bin/boringtun /usr/bin/boringtun

# Copy binary
COPY --from=build-src /src/bottlerocket/bin/vsphere-vm-resource-agent ./
# Copy licenses
COPY --from=build-src /usr/share/licenses/testsys /licenses/testsys
...
COPY --from=build /etc/pki /etc/pki
# Copy binary
COPY --from=build-src /src/bottlerocket/bin/eks-resource-agent ./
# Copy licenses
COPY --from=build-src /usr/share/licenses/testsys /licenses/testsys
...
COPY --from=build /etc/pki /etc/pki
# Copy binary
COPY --from=build-src /src/bottlerocket/bin/ecs-resource-agent ./
# Copy licenses
COPY --from=build-src /usr/share/licenses/testsys /licenses/testsys
...
# Copy binary
COPY --from=build-src /src/bottlerocket/bin/ecs-test-agent ./
# Copy licenses
COPY --from=build-src /usr/share/licenses/testsys /licenses/testsys
...
# Copy binary
COPY --from=build-src /src/bottlerocket/bin/sonobuoy-test-agent ./
# Copy licenses
COPY --from=build-src /usr/share/licenses/testsys /licenses/testsys
...
# Copy binary
COPY --from=build-src /src/bottlerocket/bin/migration-test-agent ./
# Copy SSM documents
COPY --from=build-src /src/bottlerocket/src/bin/migration-test-agent/ssm-documents/ /local/ssm-documents/
# Copy licenses
COPY --from=build-src /usr/share/licenses/testsys /licenses/testsys
